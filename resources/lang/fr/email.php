...
return [
    ...
    'great' => 'Bonjour :name,',
    'reset_btn' => 'Reinitialiser le mot de passe',
    'set_pwd'   => 'Configurer un mot de passe',
    ...
    'comment_body' => 'Un nouveau commentaire sur :item. de :user . cliquez sur le bouton ci-dessous pour le lire ou coller le lien suivant dans votre navigateur :link .'
];
