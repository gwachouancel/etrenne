      ...
      <div class="card">
        <div class="card-body">
          <div class="d-flex align-items-start justify-content-between">
            <div>
              <h4 class="card-title"><a href="{{route('admin.bats')}}" title="Retour aux BAT"><i class="fa fa-arrow-left link-green-ora icon-sm"></i></a>&nbsp;&nbsp; {{$orderitem->title}}</h4>
            </div>
          </div>
                ...
                @foreach($document as $doc)
                  <li>
                    ...
                    <div class="details">
                      ...
                      <a href="{{route('admin.bat.download', $doc)}}" style="float:right;margin-top:23px;" class="download">Telecharger</a>
...
@if($orderitem->bat->status != 'approuved' && $documents->count() && auth()->user()->role=='admin')
  <div class="row">
    <div class="col-md-12 grid-margin grid-margin-lg-0 grid-margin-md-0 stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          <div class="table-responsive">
            <div class="col-md-12 grid-margin grid-margin-lg-0 grid-margin-md-0 ">
              <div class="forms-sample text-center">                        
                <a href="{{route('admin.bat.decide',[$orderitem,'approuved'])}}" class="btn btn-lg btn-rounded btn-success" style="color:#fff">Accepter</a>
                <a href="{{route('admin.bat.decide',[$orderitem,'rejected'])}}" class="btn btn-lg btn-rounded btn-danger" style="color:#fff">Refuser</a>
              </div>
            </div>
