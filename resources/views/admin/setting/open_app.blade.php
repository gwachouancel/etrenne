    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="card-body">
                ...
                <div>
                    <h4 class="card-title"> {{__('admin/navigation.open_app')}}</h4>
                </div>
                </div>
                <br>
                ...
                <div class="col-md-12 grid-margin grid-margin-lg-0 grid-margin-md-0 ">
                    <form class="forms-sample text-center"> 
                        <p>{{__('admin/setting.open_app')}}</p> 
                        <br>                      
                        <a href="{{route('admin.setting.close',1)}}" class="btn btn-lg btn-rounded btn-success">{{__('common.yes_button')}}</a>
